...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/wang/xiaoche/yunjing/src/novok_mocap_ros-master/ekf_pose)
  set(ekf_DEVEL_PREFIX /home/wang/xiaoche/yunjing/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/wang/xiaoche/yunjing/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'kunyue <ksu@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wang/xiaoche/yunjing/src/novok_mocap_ros-master/ekf_pose/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ekf_NUM_DUMMY_TARGETS)
      set(ekf_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ekf::wrapped-linker-option${ekf_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ekf_NUM_DUMMY_TARGETS "${ekf_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ekf::wrapped-linker-option${ekf_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ekf_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ekf_EXPORTED_TARGETS ${${ekf_dep}_EXPORTED_TARGETS})
endforeach()
